...
public class CarSharingController {
    ...
    public String searchForParkingSpot(@RequestParam(value = "Lat", defaultValue = "0") int x,@RequestParam(value = "Lon", defaultValue = "0") int y) {
        // TODO : usługi
        ZoneService zoneService = new ZoneServiceImpl(null);
        ParkingLotService parkingService = new ParkingLotServiceImpl(null);
        ...
        results.sort((obj1,obj2)-> obj1.Score> obj2.Score?1:(obj1.Score < obj2.Score?(-1):0));
    ...
    @GetMapping("/GenerateZones")
    public String GenerateZones(@RequestParam(value = "amount", defaultValue = "1") int amount) {
